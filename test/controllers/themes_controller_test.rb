...
class ThemesControllerTest < ActionController::TestCase
  ...
  test "should create theme" do
    assert_difference('Theme.count') do
      post :create, theme: { content: @theme.content, image: @theme.image, name: @theme.name, theme_id: @theme.theme_id }
    end
  ...
  test "should update theme" do
    patch :update, id: @theme, theme: { content: @theme.content, image: @theme.image, name: @theme.name, theme_id: @theme.theme_id }
    assert_redirected_to theme_path(assigns(:theme))
  end
